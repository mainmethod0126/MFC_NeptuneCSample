...
void CNeptuneCSampleDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_COMBO_ROTATE, m_cbRotate);
}
...
BEGIN_MESSAGE_MAP(CNeptuneCSampleDlg, CDialogEx)
	...
	ON_CBN_SELCHANGE(IDC_COMBO_ROTATE, &CNeptuneCSampleDlg::OnCbnSelchangeComboRotate)
...
BOOL CNeptuneCSampleDlg::OnInitDialog()
{
	...
	m_cbRotate.ResetContent();
	m_cbRotate.InsertString(m_cbRotate.GetCount(), _T("0"));
	m_cbRotate.InsertString(m_cbRotate.GetCount(), _T("90"));
	m_cbRotate.InsertString(m_cbRotate.GetCount(), _T("180"));
	m_cbRotate.InsertString(m_cbRotate.GetCount(), _T("270"));
	m_cbRotate.SetCurSel(0);
...
void CNeptuneCSampleDlg::OnCbnSelchangeComboRotate()
{
	if (m_pCameraHandle)
	{
		ENeptuneRotationAngle emRotate = NEPTUNE_ROTATE_0;
		switch (m_cbRotate.GetCurSel())
		{
		case 0:	emRotate = NEPTUNE_ROTATE_0;	break;
		case 1:	emRotate = NEPTUNE_ROTATE_90;	break;
		case 2:	emRotate = NEPTUNE_ROTATE_180;	break;
		case 3:	emRotate = NEPTUNE_ROTATE_270;	break;
		}
		ntcSetRotation(m_pCameraHandle, emRotate);
	}
}
